		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cocdemos3cocapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cocdemos3cocapp-display": {
								"semanticObject": "cocdemos3cocapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coc.demo.s3cocapp",
									"url": sap.ui.require.toUrl("coc/demo/s3cocapp")
								}
							}
						}
					}
